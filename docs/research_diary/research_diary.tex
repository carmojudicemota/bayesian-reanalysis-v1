...
\begin{itemize}
    \item Built the Excel file's heading; Filled it with the values from selected Ali studies (AI)
    \item Coded: \texttt{00_setup.R} (reads the input csv index); \texttt{01_prepare_data.R} (creates necessary variables, sanity checks for data in index); \texttt{02_frequentist_checks.R} (reruns possible frequentist results) 
    \item 
\end{itemize}
...
\begin{itemize}
    \item Mann-Whitney U test => comparing ranks ignoring variance assumption & 
    \item 
    \item 
\end{itemize}
