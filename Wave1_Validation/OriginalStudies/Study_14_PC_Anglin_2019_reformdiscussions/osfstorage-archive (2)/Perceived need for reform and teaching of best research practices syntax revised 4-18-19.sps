...
CORRELATIONS
  /VARIABLES=years_teaching Intro_topics Adv_topics Grad_topics grad_replication grad_interpretation
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=teaching_load_coded Intro_topics Adv_topics Grad_topics grad_replication grad_interpretation
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=work_time_1 work_time_2 Intro_topics Adv_topics Grad_topics grad_replication grad_interpretation
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=focus work_time_1 work_time_2 Intro_topics Adv_topics Grad_topics grad_replication grad_interpretation
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
DESCRIPTIVES VARIABLES=intro_size_coded adv_size_coded grad_size_coded Intro_topics Adv_topics Grad_topics grad_replication grad_interpretation
  /STATISTICS=MEAN STDDEV MIN MAX.
...
CORRELATIONS
  /VARIABLES=Intro_topics with RAs_coded undergrad_advisees_coded grad_advisees_coded  
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.

CORRELATIONS
  /VARIABLES=Adv_topics with RAs_coded undergrad_advisees_coded grad_advisees_coded 
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.

CORRELATIONS
  /VARIABLES=Grad_topics grad_replication grad_interpretation with RAs_coded undergrad_advisees_coded grad_advisees_coded 
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=years_teaching reform
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=teaching_load_coded reform
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=work_time_1 work_time_2 focus reform
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
**Number of students supervised and perceived need for reform

CORRELATIONS
  /VARIABLES=Reform with RAs_coded undergrad_advisees_coded grad_advisees_coded  
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
CORRELATIONS
  /VARIABLES=reform with intro_topics Adv_topics Grad_topics grad_replication grad_interpretation 
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
